...
export interface RandomServerClient extends grpc.Client {
...
export interface RandomServerHandlers extends grpc.UntypedServiceImplementation {
...
export interface RandomServerDefinition extends grpc.ServiceDefinition {
